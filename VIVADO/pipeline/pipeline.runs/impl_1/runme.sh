...
HD_PWD='D:/OneDrive - Delft University of Technology/thesis/RTL/VIVADO/pipeline/pipeline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hisBuilderFSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hisBuilderFSM.tcl -notrace
