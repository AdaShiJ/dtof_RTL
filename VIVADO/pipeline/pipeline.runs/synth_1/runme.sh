...
HD_PWD='D:/OneDrive - Delft University of Technology/thesis/RTL/VIVADO/pipeline/pipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hisBuilderFSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hisBuilderFSM.tcl
